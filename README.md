# Kittygram - социальная сеть для размещения фотографий своих котиков.

## Описание проекта
Проект был написан в рамках обучения от ЯП, где пользователи могут загружать фото своих котов с кратким описание, также могут смотреть фото чужих котиков.
...
## Автор
Иван Тюрютиков - [GitHub](https://github.com/mokriiiii)
